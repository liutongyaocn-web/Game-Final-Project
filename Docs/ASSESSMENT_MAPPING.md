...
| Game AI | JU TPS provides base AI movement/detection/chase/attack/damage behaviours; Last Stand code provides enemy type wrappers, spawning, wave difficulty, score, kills, and death reporting. | JU TPS enemy candidates audited; `Zombie AI` and `Patrol AI` are recommended starting points. NavMeshSurface availability must be resolved before enemy movement testing. |
