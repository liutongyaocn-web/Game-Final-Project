...
| Game AI | JU TPS provides base AI movement/detection/chase/attack/damage behaviours; Last Stand code provides enemy type wrappers, spawning, wave difficulty, score, kills, and death reporting. | Single JU TPS Zombie AI test completed in `LS_Arena_01`; movement, close-range detection, and melee damage were confirmed. |
